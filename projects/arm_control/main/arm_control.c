...
#define EN_GPIO GPIO_NUM_13
#define SLP_GPIO GPIO_NUM_14
#define STEP_GPIO GPIO_NUM_16
#define DIR_GPIO GPIO_NUM_17

#define M1_GPIO GPIO_NUM_21
#define M2_GPIO GPIO_NUM_22

//----------------------------------------------------------------------------------------//

void stepMotor(ledc_channel_t channel){
    int32_t angle = ;
    ledc_set_duty(LEDC_HIGH_SPEED_MODE, channel, duty);
    ledc_update_duty(LEDC_HIGH_SPEED_MODE, channel);
}
...
void app_main(){
    ...
    ledc_channel_config_t ledc_conf = {
        .gpio_num = STEP_GPIO,                 // GPIO pin for PWM output
        .speed_mode = LEDC_HIGH_SPEED_MODE,    // LEDC speed mode
        .channel = LEDC_CHANNEL_0,             // LEDC channel
        .intr_type = LEDC_INTR_DISABLE,        // disable interrupt
        .timer_sel = LEDC_TIMER_0,             // timer index
